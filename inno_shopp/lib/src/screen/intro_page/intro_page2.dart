        ...
        children: [
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
              Image.asset("images/intro2.png",height: 300,width: 300,),
                KText(text: "Make Payment",fontSize: 24,fontWeight: FontWeight.bold,),
                Padding(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                        onTap: (){
                          Get.toNamed(Routes.onBoard_one);
                        },child: KText(text: "Prev",fontSize: 16,color: BrandColors.greyColor,fontWeight: FontWeight.bold,)),
                    Image.asset("images/m_circle.png",width: 40,),
                    GestureDetector(
                        onTap: (){
                        Get.toNamed(Routes.onBoard_three);
